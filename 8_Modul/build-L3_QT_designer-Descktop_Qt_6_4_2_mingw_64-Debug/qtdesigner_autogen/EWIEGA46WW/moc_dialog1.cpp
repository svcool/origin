...
#include <memory>
#include "../../../L3_QT_designer/dialog1.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Dialog1_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Dialog1_t qt_meta_stringdata_Dialog1 = {
    {
        QT_MOC_LITERAL(0, 7)   // "Dialog1"
    },
    "Dialog1"
};
...
Q_CONSTINIT static const uint qt_meta_data_Dialog1[] = {
...
Q_CONSTINIT const QMetaObject Dialog1::staticMetaObject = { {
    ...
    qt_meta_stringdata_Dialog1.offsetsAndSizes,
    qt_meta_data_Dialog1,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Dialog1_t,
        // Q_OBJECT / Q_GADGET
