...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        dtfrom_dateEdit->setDateTime(QDateTime(QDate(2016, 8, 15), QTime(2, 45, 0)));
        dtfrom_dateEdit->setMaximumDate(QDate(2017, 9, 14));
        dtfrom_dateEdit->setMinimumDate(QDate(2016, 8, 15));
        dtfrom_dateEdit->setMaximumTime(QTime(2, 45, 0));
        dtfrom_dateEdit->setMinimumTime(QTime(2, 45, 0));
        ...
        dtby_dateEdit->setDateTime(QDateTime(QDate(2016, 8, 15), QTime(2, 45, 0)));
        dtby_dateEdit->setTime(QTime(2, 45, 0));
        dtby_dateEdit->setMaximumDate(QDate(2017, 9, 14));
        dtby_dateEdit->setMinimumDate(QDate(2016, 8, 15));
        dtby_dateEdit->setMaximumTime(QTime(2, 45, 0));
        dtby_dateEdit->setMinimumTime(QTime(2, 45, 0));
        dtby_dateEdit->setCalendarPopup(true);
        dtby_dateEdit->setCurrentSectionIndex(0);
        dtby_dateEdit->setDate(QDate(2016, 8, 15));

        gridLayout_3->addWidget(dtby_dateEdit, 7, 1, 1, 1);

        dif_checkBox = new QCheckBox(groupBox);
        dif_checkBox->setObjectName("dif_checkBox");

        gridLayout_3->addWidget(dif_checkBox, 8, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        dif_checkBox->setText(QCoreApplication::translate("MainWindow", "\320\262\320\272\320\273\321\216\321\207\320\270\321\202\321\214 \320\264\320\270\320\260\320\277\320\260\320\267\320\276\320\275", nullptr));
