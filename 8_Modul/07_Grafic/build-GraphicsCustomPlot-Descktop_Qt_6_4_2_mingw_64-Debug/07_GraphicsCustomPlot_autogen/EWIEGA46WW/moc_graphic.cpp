...
#include <memory>
#include "../../../GraphicsCustomPlot/graphic.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Graphic_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Graphic_t qt_meta_stringdata_Graphic = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Graphic[] = {
...
Q_CONSTINIT const QMetaObject Graphic::staticMetaObject = { {
    ...
    qt_meta_stringdata_Graphic.offsetsAndSizes,
    qt_meta_data_Graphic,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Graphic_t,
        // Q_OBJECT / Q_GADGET
